<x-app-layout>
    <div class="py-6 px-4 max-w-5xl mx-auto">
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <h2 class="text-xl font-bold mb-6 text-gray-800 border-b pb-3">Tambah Data Aplikasi Baru</h2>

            <form action="{{ route('admin.aplikasi.store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_aplikasi" id="nama_aplikasi" value="{{ old('nama_aplikasi') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="server" id="server" value="{{ old('server') }}"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="bahasa_pemograman" id="bahasa_pemograman" value="{{ old('bahasa_pemograman') }}"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="framework" id="framework" value="{{ old('framework') }}"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="os_server" id="os_server" value="{{ old('os_server') }}"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="database_engine" id="database_engine" value="{{ old('database_engine') }}"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="web_server" id="web_server" value="{{ old('web_server') }}"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="password_server" id="password_server" value="{{ old('password_server') }}"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                    </div>
                </div>
